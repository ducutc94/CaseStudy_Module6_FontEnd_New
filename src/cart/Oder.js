...
// Nhóm các món hàng dựa trên tên cửa hàng
                                            ...
                                            <span className="view_category_totalMoney">
                                                ...
                                                {statusBill === "2" && <span  style={{color:`red`, fontSize:`14px`}}>Đang chờ xác nhận</span>}
                                                     ...
                                                     Tổng tiền: &nbsp;
                                                        ...
                                                        <button className="btn-orange" type="submit" onClick={() => deleteCart()}> Hủy</button>
                                                    </div>
                                                </div>
                                            </React.Fragment>
                                        );
    ...
    //
    //                     <div className="view_category">
    //                         {Object.keys(groupedItems).map(combinedKey => {
    //                             const [shopName] = combinedKey.split('-');
    //                             const [statusBill] = combinedKey.split('-');
    //                             const itemsForGroup = groupedItems[combinedKey];
    //
    //                             return (
    ...
    //                                                                     <div className="view_category_item-21-img">
    //                                                                         <img
    //                                                                             src={item.productsCartsList[0].products.image}
    //                                                                             alt="Product Image"
    //                                                                         />
    //                                                                     </div>
    //                                                                     <div className="view_category_item-21-about">
    //                                                                         <span className="view_category_item-21-name">{item.shops.name}</span>
    //                                                                         <div className="view_category_item-21-category">
    //                                                                             <span className="view_category_item-21-category-voucher">Voucher: </span>
    //                                                                             <span className="view_category_item-21-category-percent">{item.productsCartsList[0].products.voucher.name}</span>
    //                                                                         </div>
    //                                                                         <div className="view_category_item-21-img1">
    //                                                                             <img src="../static/img/category.jpg" alt="Category Image" />
    //                                                                         </div>
    ...
    //                                                                         style: 'currency',
    //                                                                         currency: 'VND'
    //                                                                     }).format(item.productsCartsList[0].products.price)}
    //                                                                 </span>
    //                                                             </div>
    //                                                             <div className="view_category_item-4">
    //                                                                 <span className="view_category_item-41">Số lượng </span>
    //                                                                 <span className="view_category_item-42">{item.productsCartsList[0].products.quantity}</span>
    //                                                             </div>
    //                                                             <div className="view_category_item-4">
    //                                                                 <span className="view_category_item-41">Số tiền </span>
    //                                                                 <span className="view_category_item-42">
    ...
    //                                                                         style: 'currency',
    //                                                                         currency: 'VND'
    //                                                                     }).format(item.productsCartsList[0].products.money)}
    //                                                                 </span>
    //                                                             </div>
    //                                                         </div>
    //                                                 </div>
    ...
    //                                         <span className="view_category_totalMoney">
    //                                             Trạng thái đơn:
    //                                             {statusBill === "0" && <> <p>Đã thanh toán</p> </>}
    //                                             {statusBill === "1" && <> <p>Huỷ thanh toán</p> </>}
    //                                             {statusBill === "2" && <> <p>Đang chờ xác nhận</p></>}
    //                                         </span>
    //                                             <button className="btn-orange" type="submit" onClick={() => deleteCart()}> Hủy</button>
    //                                         </div>
    //                                     </div>
